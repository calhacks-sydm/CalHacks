...
CREATE TABLE "UserTopics" (
    ...
    CONSTRAINT "UserTopics_pkey" PRIMARY KEY ("user_id","course_id","topic_id")
);
...
-- AddForeignKey
ALTER TABLE "UserTopics" ADD CONSTRAINT "UserTopics_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "CourseInfo"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
