    ...
    return (
        <div className="flex my-10 mx-24 justify-center">
            ...
            <div className="flex flex-col items-center">
                ...
                <select placeholder="select course" defaultValue="" value={course} onChange={handleCourseSelect}
                ...
                <Button disabled={course==""?true:false} className='text-white w-40 bg-green-500 hover:bg-green-400' onClick={(handleSubmit) => setGenerated(true)}>Generate Test</Button>  
            </div>}
        </div>
    )
}